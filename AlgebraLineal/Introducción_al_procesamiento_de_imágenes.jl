...
# ╔═╡ b0c0cda0-bc29-11ed-341b-5d576c844797
begin
...
# ╔═╡ db2112c5-0d36-479a-bab1-94502323c36f
begin
	using Unitful 
...
PlutoUI.TableOfContents(title="Ejemplo de ajuste de parámetros", aside=true)
...
# ╔═╡ 34ec96db-c9c6-4f0e-82d2-164053d77488
md"""Usaremos la siguientes librerías"""

# ╔═╡ 4e70f0af-d68c-4717-9fe6-d672c0d163bc
...
# ╔═╡ 89950411-6b3c-42bf-ae48-eb68c17fb999
imag = load(fname)

# ╔═╡ 33af1086-a8d6-42e7-b6d0-7d07dfee05b8
...
# ╔═╡ a1eeda47-5144-4ab1-97f2-078adcb730ca
typeof(imag)

# ╔═╡ a8fd19a7-08d7-4f95-8fd3-c091af869e61
md"""El tamaño de la imágen es:"""

# ╔═╡ 1f205174-81f7-4520-99fe-2d4de84741f9
imag_size = size(imag)

# ╔═╡ 9c08c150-ab3c-434d-b1e7-2487934c307b
md"""
...
# ╔═╡ 52fbe87a-e952-4f9f-881b-d02cbf7d413e
a_pixel = imag[50, 44]

# ╔═╡ c5914468-b93c-4b95-bb1b-34910347d80d
md"""
...
# ╔═╡ 4386b547-ede7-42e0-9569-b63cb68f360e
typeof(a_pixel)

# ╔═╡ 76481cd6-90d2-4c2e-83f4-dc12c35f9bb2
md"""Tenemos para este píxel en particular los siguientes valores:"""

# ╔═╡ 534ab7cf-0c57-4833-87a4-7ae67ccde581
[a_pixel.r, a_pixel.g, a_pixel.b]

# ╔═╡ 62655d95-27d8-4487-b68d-570d90e9ed18
md"""Podemos crear un píxel de la siguiente forma. """

# ╔═╡ 6fdb84f4-bf67-4fbe-890f-71508b488190
a_pixel2=RGB(0.5,0.0,0.5)

# ╔═╡ 2a989e43-a63f-44ea-bf9c-81665eae5614
md"""
...
# ╔═╡ d9772bc2-a4ab-439a-ab0d-ecfa1745b94f
...
# ╔═╡ ffabcd6e-ec84-4d6b-98c3-8be63eed971b
imag[30:120, 1:100]

# ╔═╡ 6013c9d9-1579-4505-91f7-b8ebed9e3036
md"""
Si desplegamos una sola fila, obtenemos lo siguiente. 
"""

# ╔═╡ d4c14b5d-01a0-46f6-9d82-43933daa695a
imag[45, :]

# ╔═╡ 6c943532-1e22-44c9-8f7f-377d0898f26e
md"""
La sección con las primeras filas y primeras columnas es:
 """

# ╔═╡ c36a5446-1990-43bb-833b-7e66a4d13363
subimag=imag[300:450,50:150]

# ╔═╡ f18c3fa0-6e53-4afc-af20-0c8774c7b56c
...
# ╔═╡ c5b4fafc-6d8d-4747-809d-898b319f5d75
md"""### Colores 
...
# ╔═╡ 9e89f0f7-3350-4053-a268-4bbbc937f63b
md"""Una imagen gradiente."""

# ╔═╡ 02e08dee-e688-4c5a-a45f-704d34f01823
[RGB(i, j, 0) for i in 0:0.1:1, j in 0:0.1:1]

# ╔═╡ 3d9c2e23-1628-4866-95f0-23dfc911c4f6
md""" ### Matriz de píxeles """

# ╔═╡ 7a47cd0e-610b-4eb0-af19-0f214b99018a
md""" 
Podemos asignar manualmente valores expecificos a píxeles. Observe la siguiente imagen.
"""

# ╔═╡ b59e00fc-7a32-4309-b24a-5d50775a2b86
let
...
# ╔═╡ 6657488a-a315-4cc9-b3a0-6f02555b8bab
md"""### Procesamiento con el operador de Broadcasting """

# ╔═╡ 4392fce0-56f4-4eba-884f-50db646a0360
...
# ╔═╡ b704e11d-5354-45a9-9d4c-e896992243ee
md"""Por ejemplo, le podemos quitar los píxeles rojos de la imagen con la siguiente función."""

# ╔═╡ 95f557ec-e460-442e-b8f9-c10463e01e86
function nored(a)
b=RGB(0.0,a.g,a.b)
return b
end

# ╔═╡ ad6dc0cc-cdb8-42c7-bb05-5e37336c9af3
md"""Observe cómo varía un píxel de la imagen."""

# ╔═╡ d53aa3ec-0756-492a-9e32-1ed03042e92a
[a_pixel,nored(a_pixel)]

# ╔═╡ 242d34b6-aa54-4512-877d-87b50ddaf0fd
md"""Julia extiende el operador de transmisión de MatLab. Veamos el siguiente ejemplo. """

# ╔═╡ cefe3f75-f07e-4be9-bdce-cc944926c50a
partenored=nored.(parte)

# ╔═╡ 3bb87cf2-2c70-465f-a514-814444a60c3b
md"""### Procesamiento """

# ╔═╡ 42707407-d2ba-4953-a21a-3fb315aec07f
...
# ╔═╡ 26189d72-c224-4683-a60d-90ddfa41182e
...
# ╔═╡ 794edddf-21d9-4776-8db2-b1fede6e7402
md""" También podemos invertir la imagen, reordenando la matriz asociada.
"""

# ╔═╡ 7f4e08a2-d5ec-44f8-8822-7642223e773e
upsidedown= temp[ end:-1:1 , :]

# ╔═╡ 5fecefee-7ce7-49ac-a36c-74288b295bf6
...
# ╔═╡ e4d288c1-efc9-493f-b364-5c5e639a8a6d
(.5 * upsidedown .+ .5 *temp)

# ╔═╡ 1522efbc-169f-4059-979e-7b2dc1f35452
@bind α Slider(0:.01:1 , show_value=true, default = 1.0)

# ╔═╡ 93574c1d-f567-4b06-8dd4-1c7eab448c56
(α * upsidedown .+ (1-α) * temp) 

# ╔═╡ 7e71dc9a-b576-442a-bb9d-4887676fc78d
md"""### Filtros"""

# ╔═╡ 105cb5f3-94b6-4dee-a71e-6adcf42ef1a4
md"""
...
>>>>>>> Stashed changes
manifest_format = "2.0"
project_hash = "e900b378530548b743054da381cdc35252375b28"
