...
# ╔═╡ 12282ad2-8afd-4c63-8b43-e4942a65a7db
using PlutoUI
...
# ╔═╡ 4c42c02f-206d-4ac9-b17a-9547bb9da4cd
PlutoUI.TableOfContents(title="Ajuste de parámetros", aside=true)

# ╔═╡ 4b2ab249-76bc-4ac9-b759-84b22974197b
...
# ╔═╡ 6a7fc2c0-cd11-11ee-2990-878321ef9254
md"""Elaborado por Juan Galvis, Francisco Gómez y Yessica Trujillo. 
"""

# ╔═╡ 61a85d47-c1bc-4bdf-8b57-82bdfcde8a4a
md"""Usaremos las siguientes librerías:"""

# ╔═╡ 45df3d17-843b-47d8-a42c-63ed9658f5a0
md"""# Introducción  
...
# ╔═╡ 40142d89-a3c9-4bdc-990b-4f0e0e2c8111
md"""# Modelo de ecuaciones diferenciales"""
...
# ╔═╡ d7cfa0e1-b33c-49fa-8de5-172af9bc0719
...
# ╔═╡ 186f0ac7-0402-4f12-844e-8b9e1b57318a
...
# ╔═╡ 3236b785-9666-41e5-8008-288b6dafe45f
...
# ╔═╡ 4476f579-7e7b-4c08-9de8-a14a4197bebc
...
# ╔═╡ 6b2e11e9-1723-4765-933d-de790615785d
modeloLG(V,par,t)=par[1]*V*(1-V/par[2])

# ╔═╡ 09be6b1e-c2d6-4c22-a1a9-c9f50b6691dd
...
# ╔═╡ e22328df-36f5-4af1-b549-1f3d08e7deb4
begin
	tspan₂=(3.26,80)
	V0₂=0.0158
	par₂=[1.0,1.0]
...
# ╔═╡ 2e9ec7b4-2af4-46c7-a23e-b025c5d8d550
...
# ╔═╡ b0b87167-c98f-49c9-8043-e1e9cda75354
...
# ╔═╡ 90018436-1cc5-4e46-a29d-addeb9b744e5
md"""Por ejemplo el desajuste de usar $a=1$ y $b=1$ en el modelo es de:"""

# ╔═╡ 795b190a-4189-46cd-a460-05bd8b921fb0
 residuoLG([1 1],volumen,tiempo)

# ╔═╡ f88a41ed-8da8-4071-9ee2-ea7ae03071dc
...
# ╔═╡ 961ae4cb-6d2f-4933-ac51-6531f5463466
rLG(par₂) = residuoLG(par₂, volumen, tiempo)

# ╔═╡ 14883b95-96f9-456b-9f03-96af1f710774
md"""y, optimizamos su valor"""

# ╔═╡ 0914a564-699b-4c7f-8904-d4918361078d
oLG=Optim.optimize(rLG, [.01,.01], NelderMead())

# ╔═╡ c5f04227-1616-4b3d-98ad-ee8755e99ff6
oLG.minimizer

# ╔═╡ 04b50219-d91e-48af-a86b-0095d853672c
...
# ╔═╡ 2ef7fbdd-4f56-4339-ace0-5ae602b861f6
begin
	oLGm=oLG.minimizer
...
[1] Revision of the textbook Fundamentals of Numerical Computation by Tobin A. Driscoll and Richard J. Braun. The book was originally written for MATLAB, but this resource has been adapted to suit Julia. https://tobydriscoll.net/fnc-julia/frontmatter.html

[2] Sullivan, Eric. Numerical Methods: An Inquiry-Based Approach With Python. 2020.

[3] Bulirsch, Roland, Josef Stoer, and J. Stoer. Introduction to numerical analysis. Vol. 3. Heidelberg: Springer, 2002.

[4] Stewart, Gilbert W. Afternotes on numerical analysis. Society for Industrial and Applied Mathematics, 1996.

[5] Quarteroni, Alfio, Fausto Saleri, and Paola Gervasio. Scientific computing with MATLAB and Octave. Vol. 3. Berlin: Springer, 2006.

[6] Machine Learning and Data Mining
Lecture Notes, http://www.dgp.toronto.edu/~hertzman/411notes.pdf

[7] Deep Learning, https://www.deeplearningbook.org/lecture_slides.html"""
